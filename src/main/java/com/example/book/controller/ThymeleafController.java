...
//    }
    ...
    public String thymeleafSample(HttpServletRequest request,
        ...
        model.addAttribute("sessionMessage", sessionMessage); // 모델에 서버에 있는 session을 달아서 사용자에게 전달
        ...
        model.addAttribute("cookieMessage", cookieValue); // springbookt에서 MVC패턴으로 데이터를 실어나를 때는
